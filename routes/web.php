...
Route::group(['middleware' => ['auth']], function() {
        ...
        Route::get('transaction_matser_point_o_f_sale_purchase_commissions_', [App\Http\Controllers\Dashbored\TransactionMatserPointOFSalePurchaseCommission_Controller::class, 'index'])->name('transaction_matser_point_o_f_sale_purchase_commission_');
        Route::get('transaction_matser_point_o_f_sale_purchase_commission_/uplode', [App\Http\Controllers\Dashbored\TransactionMatserPointOFSalePurchaseCommission_Controller::class, 'uplode'])->name('transaction_matser_point_o_f_sale_purchase_commission_/uplode');
        Route::post('transaction_matser_point_o_f_sale_purchase_commission_/uplode', [App\Http\Controllers\Dashbored\TransactionMatserPointOFSalePurchaseCommission_Controller::class, 'storeUplode'])->name('transaction_matser_point_o_f_sale_purchase_commission_/store_uplode');
        Route::get('transaction_matser_point_o_f_sale_purchase_commission_/report/branche', [App\Http\Controllers\Dashbored\TransactionMatserPointOFSalePurchaseCommission_Controller::class, 'generateReportView'])->name('transaction_matser_point_o_f_sale_purchase_commission_/report/branche');
        Route::get('transaction_matser_point_o_f_sale_purchase_commission_/report/', [App\Http\Controllers\Dashbored\TransactionMatserPointOFSalePurchaseCommission_Controller::class, 'generateReportViewAll'])->name('transaction_matser_point_o_f_sale_purchase_commission_/report');
