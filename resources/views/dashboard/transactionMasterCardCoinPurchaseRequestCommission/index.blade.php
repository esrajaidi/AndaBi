...
<div class="row small-spacing">
    <div class="col-xs-12">
      <div class="box-content">
        ...
        <br>
        <a class="btn btn-success" href="{{ route('transaction_master_card_coin_purchase_request_commissions/uplode') }}">تحميل ملف  </a>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="transaction_master_card_coin_purchase_request_commissions_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#transaction_master_card_coin_purchase_request_commissions_tbl').DataTable({
        ...
        buttons: [
            ...
            ajax: {
              url: "{{ route('transaction_master_card_coin_purchase_request_commissions') }}",
              data:{brn:brn,
              }
        ...
        $('#reset').click(function(){
            $('#brn').val('');
            $('#transaction_a_t_m_o_f_f_transaction_master_card_coin_purchase_request_commissions_tblu_s_fees_tbl').DataTable().destroy();
        fill_datatable();
         });
        ...
        var brn = $('#brn').val();
            ...
            $('#transaction_master_card_coin_purchase_request_commissions_tbl').DataTable().destroy();
            fill_datatable(brn)
