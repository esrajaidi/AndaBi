...
<div class="row small-spacing">
    <div class="col-xs-12">
      <div class="box-content">
        ...
        <br>
        <a class="btn btn-success" href="{{ route('transaction_o_b_d_x_coms/uplode') }}">تحميل ملف  </a>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="transaction_o_b_d_x_coms_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#transaction_o_b_d_x_coms_tbl').DataTable({
        ...
        buttons: [
            ...
            ajax: {
              url: "{{ route('transaction_o_b_d_x_coms') }}",
              data:{brn:brn,
              }
        ...
        $('#reset').click(function(){
            $('#brn').val('');
            $('#transaction_o_b_d_x_coms_tbl').DataTable().destroy();
        fill_datatable();
         });
