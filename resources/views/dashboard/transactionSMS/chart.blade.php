...
<div class="col-xs-5">
    <canvas id="s_m_s_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var s_m_s_chart = document.getElementById('s_m_s_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_s_m_s($month_year);
    ...
    var totalAmountChart = new Chart(s_m_s_chart, {
