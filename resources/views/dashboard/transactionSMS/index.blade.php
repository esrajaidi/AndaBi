...
@section('title', 'عمولة اشتراك في خدمة sms أفراد')
@section('content')
<style>
  .btn-export {
...
<div class="row small-spacing">
    <div class="col-xs-12">
      <div class="box-content">
        <h3 ><i class="ico fa fa-newspaper-o"></i> @yield('title')</h3>
        <br>
        <a class="btn btn-success" href="{{ route('transaction_s_m_s/uplode') }}">تحميل ملف  </a>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="transaction_s_m_s_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#transaction_s_m_s_tbl').DataTable({
        ...
        $('#reset').click(function(){
            $('#brn').val('');
            $('#transaction_s_m_s_tbl').DataTable().destroy();
        fill_datatable();
         });
