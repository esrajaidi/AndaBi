...
<div class="col-xs-5">
    <canvas id="master_card_issuing_fees_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var master_card_issuing_fees_chart = document.getElementById('master_card_issuing_fees_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_master_card_issuing_fees($month_year);
    ...
    var chartData = {
        labels: labels,
        datasets: [{
            label: 'عمولة اصدار بطاقة ماستر كارد بلاتينيوم',
            data: data,
    ...
    var totalAmountChart = new Chart(master_card_issuing_fees_chart, {
