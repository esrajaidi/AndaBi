...
<div class="row small-spacing">
    <div class="col-xs-12">
      <div class="box-content">
        ...
        <br>
        <a class="btn btn-success" href="{{ route('transaction_master_card_issuing_fees/uplode') }}">تحميل ملف  </a>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="transaction_master_card_issuing_fees_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#transaction_master_card_issuing_fees_tbl').DataTable({
        ...
        buttons: [
            ...
            ajax: {
              url: "{{ route('transaction_master_card_issuing_fees') }}",
              data:{brn:brn,
              }
        ...
        $('#reset').click(function(){
            $('#brn').val('');
            $('#transaction_master_card_issuing_fees_tbl').DataTable().destroy();
        fill_datatable();
         });
