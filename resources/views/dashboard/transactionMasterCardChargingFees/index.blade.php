...
@section('title', 'Transaction MasterCard Charging Fees')
@section('content')
<style>
  .btn-export {
...
<div class="row small-spacing">
    <div class="col-xs-12">
      <div class="box-content">
        <h3 ><i class="fa fa-cc-mastercard"></i> @yield('title')</h3>
        <br>
        <a class="btn btn-success" href="{{ route('transaction_master_card_charging_fees/uplode') }}">تحميل ملف  </a>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="transaction_master_card_charging_fees_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#transaction_master_card_charging_fees_tbl').DataTable({
        ...
        buttons: [
            ...
            ajax: {
              url: "{{ route('transaction_master_card_charging_fees') }}",
              data:{brn:brn,
              }
        ...
        $('#reset').click(function(){
            $('#brn').val('');
            $('#transaction_master_card_charging_fees_tbl').DataTable().destroy();
        fill_datatable();
         });
