...
<div class="col-xs-5">
    <canvas id="master_a_t_m_s_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var master_a_t_m_s_chart = document.getElementById('master_a_t_m_s_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_master_a_t_m_s($month_year);
    ...
    var totalAmountChart = new Chart(master_a_t_m_s_chart, {
