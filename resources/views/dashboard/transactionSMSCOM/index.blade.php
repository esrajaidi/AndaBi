...
<div class="row small-spacing">
    <div class="col-xs-12">
      <div class="box-content">
        ...
        <br>
        <a class="btn btn-success" href="{{ route('transaction_s_m_s_c_o_m_s/uplode') }}">تحميل ملف  </a>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="transaction_s_m_s_c_o_m_s_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#transaction_s_m_s_c_o_m_s_tbl').DataTable({
        ...
        buttons: [
            ...
            ajax: {
              url: "{{ route('transaction_s_m_s_c_o_m_s') }}",
              data:{brn:brn,
              }
        ...
        $('#reset').click(function(){
            $('#brn').val('');
            $('#transaction_s_m_s_c_o_m_s_tbl').DataTable().destroy();
        fill_datatable();
         });
