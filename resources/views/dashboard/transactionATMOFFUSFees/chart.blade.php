...
<div class="col-xs-5">
    <canvas id="a_t_m_o_f_f_u_s_fees_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var a_t_m_o_f_f_u_s_fees_chart = document.getElementById('a_t_m_o_f_f_u_s_fees_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_a_t_m_o_f_f_u_s_fees($month_year);
    ...
    var totalAmountChart = new Chart(a_t_m_o_f_f_u_s_fees_chart, {
