...
@section('title', 'تقرير عمولة سحب من الة السحب الداتي مصارف تجارية')
@section('content')
    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box-content ">
            ...
            <div class="card-content">
                ...
                <form  method="get" action="{{ route('transaction_a_t_m_o_f_f_u_s_fees/report') }}"  enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
...
$(document).ready(function(){
        ...
        $('#reset').click(function(){
            ...
            var redirectUrl = "{{ route('transaction_a_t_m_o_f_f_u_s_fees/report') }}";
