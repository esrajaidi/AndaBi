...
@section('title', 'تقرير عمولة شراء ويسترن يونيون')
@section('content')
<style>
  .btn-export {
...
<div class="row small-spacing">
    <div class="col-xs-12">
      <div class="box-content">
        ...
        <br>
        <a class="btn btn-success" href="{{ route('transaction_w_u_purchase_commissions/uplode') }}">تحميل ملف  </a>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="transaction_w_u_purchase_commissions_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#transaction_w_u_purchase_commissions_tbl').DataTable({
        ...
        buttons: [
            ...
            ajax: {
              url: "{{ route('transaction_w_u_purchase_commissions') }}",
              data:{brn:brn,
              }
