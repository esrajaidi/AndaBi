...
<div class="col-xs-5">
    <canvas id="w_u_s_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var w_u_s_chart = document.getElementById('w_u_s_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_w_u_s($month_year);
    ...
    var chartData = {
        labels: labels,
        datasets: [{
            label: ' عمولة حوالات ويستر يونيون صادرة',
            data: data,
    ...
    var totalAmountChart = new Chart(w_u_s_chart, {
