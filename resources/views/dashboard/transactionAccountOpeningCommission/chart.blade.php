...
<div class="col-xs-5">
    <canvas id="account_opening_commissions_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var account_opening_commissions_chart = document.getElementById('account_opening_commissions_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_account_opening_commissions($month_year);
    ...
    var totalAmountChart = new Chart(account_opening_commissions_chart, {
