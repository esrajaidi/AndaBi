...
<div class="col-xs-5">
    <canvas id="incom_card_fees_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var incom_card_fees_chart = document.getElementById('incom_card_fees_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_incom_card_fees($month_year);
    ...
    var chartData = {
        labels: labels,
        datasets: [{
            label: 'ايرادات بطاقات الدفع المسبق',
            data: data,
    ...
    var totalAmountChart = new Chart(incom_card_fees_chart, {
