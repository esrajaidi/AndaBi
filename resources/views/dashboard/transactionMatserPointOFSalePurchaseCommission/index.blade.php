...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="matser_point_o_f_sale_purchase_commissions_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#matser_point_o_f_sale_purchase_commissions_tbl').DataTable({
        ...
        buttons: [
            ...
            ajax: {
              url: "{{ route('transaction_matser_point_o_f_sale_purchase_commissions') }}",
              data:{brn:brn,
              }
        ...
        $('#reset').click(function(){
            $('#brn').val('');
            $('#matser_point_o_f_sale_purchase_commissions_tbl').DataTable().destroy();
        fill_datatable();
         });
