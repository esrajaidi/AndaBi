...
<div class="col-xs-5">
    <canvas id="matser_point_o_f_sale_purchase_commissions_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var matser_point_o_f_sale_purchase_commissions_chart = document.getElementById('matser_point_o_f_sale_purchase_commissions_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_matser_point_o_f_sale_purchase_commissions($month_year);
    ...
    var totalAmountChart = new Chart(matser_point_o_f_sale_purchase_commissions_chart, {
