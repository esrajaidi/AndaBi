...
@section('title', 'Transaction Matser Point OF Sale Purchase Commission Report')
@section('content')
    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box-content ">
            ...
            <div class="card-content">
                ...
                <form  method="get" action="{{ route('transaction_matser_point_o_f_sale_purchase_commissions/report') }}"  enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
...
$(document).ready(function(){
        ...
        $('#reset').click(function(){
            ...
            var redirectUrl = "{{ route('transaction_matser_point_o_f_sale_purchase_commissions/report') }}";
