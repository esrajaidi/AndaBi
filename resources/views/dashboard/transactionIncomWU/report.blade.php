...
@section('title', 'تقرير عمولة على الحوالاات الخارجية الواردة')
@section('content')
    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box-content ">
            ...
            <div class="card-content">
                ...
                <form  method="get" action="{{ route('transaction_incom_w_u_s/report') }}"  enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
...
$(document).ready(function(){
        ...
        $('#reset').click(function(){
            ...
            var redirectUrl = "{{ route('transaction_incom_w_u_s/report') }}";
