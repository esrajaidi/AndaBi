...
<div class="col-xs-5">
    <canvas id="incom_w_u_schart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var incom_w_u_schart = document.getElementById('incom_w_u_schart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_incom_w_u_s($month_year);
    ...
    var chartData = {
        labels: labels,
        datasets: [{
            label: 'عمولة على الحوالاات الخارجية الواردة',
            data: data,
    ...
    var totalAmountChart = new Chart(incom_w_u_schart, {
