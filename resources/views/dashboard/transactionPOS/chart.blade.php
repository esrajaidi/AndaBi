...
<div class="col-xs-5">
    <canvas id="p_o_s_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var p_o_s_chart = document.getElementById('p_o_s_chart').getContext('2d');
    ...
    $transaction = \App\Classes\HelperC::get_transaction_p_o_s($month_year);
    ...
    var totalAmountChart = new Chart(p_o_s_chart, {
