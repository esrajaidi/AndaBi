...
<div class="col-xs-5">
    <canvas id="markup_fees_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var markup_fees_chart = document.getElementById('markup_fees_chart').getContext('2d');
    ...
    var chartData = {
        labels: labels,
        datasets: [{
            label: 'عمولة شراء بطاقات ماستر كارد عبر نقاط البيع ',
            data: data,
    ...
    var totalAmountChart = new Chart(markup_fees_chart, {
