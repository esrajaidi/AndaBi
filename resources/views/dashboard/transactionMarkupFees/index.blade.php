...
<div class="row small-spacing">
    <div class="col-xs-12">
      <div class="box-content">
        <h3 ><i class="ico glyphicon glyphicon-th-large"></i> @yield('title')</h3>
        <br>
        <a class="btn btn-success" href="{{ route('transaction_markup_fees/uplode') }}">تحميل ملف  </a>
...
<br>
  ...
  <div class="table-responsive">
    <table class="table table-striped" style="width: 100%" id="transaction_a_t_m_o_f_f_u_s_fees_tbl">
        <thead>
            <tr>
                <th>ID</th>
...
$(document).ready(function(){
  fill_datatable();
          ...
          {
            var table = $('#transaction_a_t_m_o_f_f_u_s_fees_tbl').DataTable({
        ...
        buttons: [
            ...
            ajax: {
              url: "{{ route('transaction_markup_fees') }}",
              data:{brn:brn,
              }
        ...
        $('#reset').click(function(){
            $('#brn').val('');
            $('#transaction_a_t_m_o_f_f_u_s_fees_tbl').DataTable().destroy();
        fill_datatable();
         });
