...
<div class="col-xs-5">
    <canvas id="card_re_issuing_fees_chart"></canvas>
</div>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    var card_re_issuing_fees_chart = document.getElementById('card_re_issuing_fees_chart').getContext('2d');
    ...
    @foreach ($months as $month)
        @php
            ...
            $transaction = \App\Classes\HelperC::get_transaction_card_re_issuing_fees($month_year);
    ...
    var chartData = {
        labels: labels,
        datasets: [{
            label: 'اعادة إصدار بطاقة بدل فاقد',
            data: data,
    ...
    var totalAmountChart = new Chart(card_re_issuing_fees_chart, {
