...
use App\Imports\TransactionMarkupFeesImport;
use App\Models\Branche;
use App\Models\TransactionMarkupFees;
...
class TransactionMarkupFeesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
        $data = TransactionMarkupFees::latest()->get();
       ...
       return view('dashboard.transactionMarkupFees.index')->with('branches',$branches);
}
   ...
   public function uplode(){
        ...
        return view('dashboard.transactionMarkupFees.uplode');
    ...
    public function storeUplode(Request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request,$fileName) {
                Excel::import(new TransactionMarkupFeesImport, $request->file('file'));
            ...
            return redirect('transaction_markup_fees');
        } catch (\Exception $e) {
    ...
    { 
        ...
        ->get();
            ...
            $query = DB::table('transaction_markup_fees')
            ->select(DB::raw('
        ...
        return view('dashboard.transactionMarkupFees.report_bybranche')
        ->with('data',$data)
    ...
    {       
        ...
        $fileName="transactionMarkupFees_bybranche_".str_replace( array( '\'', '/',"-" ), '', Now()->toDateString()).".xlsx";
        ActivityLogger::activity($fileName. "تم تصدير ملف  تحت اسم ");
     ...
     */
     ...
     { 
         ...
         return view('dashboard.transactionMarkupFees.report')
         ->with('data',$data);
     ...
     {       
         ...
         $fileName="transactionMarkupFees_".str_replace( array( '\'', '/',"-" ), '', Now()->toDateString()).".xlsx";
         ActivityLogger::activity($fileName. "تم تصدير ملف  تحت اسم");
