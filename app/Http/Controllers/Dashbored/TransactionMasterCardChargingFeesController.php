...
use App\Models\TransactionMasterCardChargingFees;
...
class TransactionMasterCardChargingFeesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
        $data = TransactionMasterCardChargingFees::latest()->get();
       ...
       return view('dashboard.transactionMasterCardChargingFees.index')->with('branches',$branches);
}
   ...
   public function uplode(){
        ...
        return view('dashboard.transactionMasterCardChargingFees.uplode');
    ...
    public function storeUplode(Request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request,$fileName) {
                Excel::import(new TransactionMasterCardChargingFeesImport, $request->file('file'));
                          
            });
            
            ActivityLogger::activity($fileName.'تمت عملية  تحميل ملف Transaction Master Card Charging  Fees  بنجاح');

            Alert::success('تمت عملية  تحميل ملف  بنجاح');

            return redirect('transaction_master_card_charging_fees');
        } catch (\Exception $e) {
    ...
    { 
        ...
        ->get();
            ...
            $query = DB::table('transaction_master_card_charging_fees')
            ->select(DB::raw('
        ...
        return view('dashboard.transactionMasterCardChargingFees.report_bybranche')
        ->with('data',$data)
    ...
    {       
        ...
        $fileName="transactionMasterCardChargingFees_bybranche_".str_replace( array( '\'', '/',"-" ), '', Now()->toDateString()).".xlsx";
        ActivityLogger::activity($fileName. "تم تصدير ملف  تحت اسم ");
     ...
     */
     ...
     { 
         ...
         return view('dashboard.transactionMasterCardChargingFees.report')
         ->with('data',$data);
     ...
     {       
         ...
         $fileName="transactionMasterCardChargingFees_".str_replace( array( '\'', '/',"-" ), '', Now()->toDateString()).".xlsx";
         ActivityLogger::activity($fileName. "تم تصدير ملف  تحت اسم");
