...
class TransactionMasterCardCoinPurchaseRequestCommissionFeesImport implements ToModel,WithStartRow
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        if ($row[3] !='IC109011679') {
          
            ActivityLogger::activity("the entry ac_no is ".$row[3]."not  IC109011679 Transaction MasterCard Coin Purchase Request Commission FeesImport" );
            return null;
        }
        ...
        return new TransactionMasterCardCoinPurchaseRequestCommission([
            'trn_ref_no' => $row[0],
            'event' => $row[1],
            'brn' => $row[2],
            'ac_no' => $row[3],
