...
class TransactionMatserPointOFSalePurchaseCommissionImport_ implements ToModel,WithStartRow
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        if ($row[3] !='IC109011655') {
          
            ActivityLogger::activity("the entry ac_no is ".$row[3]."not  IC109011655 in Transaction Matser Point OF Sale Purchase Commission_ Import" );
            return null;
        }
        ...
        return new TransactionMatserPointOFSalePurchaseCommission_([
            'trn_ref_no' => $row[0],
            'event' => $row[1],
            'brn' => $row[2],
            'ac_no' => $row[3],
