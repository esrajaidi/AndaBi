...
class TransactionsWUSMSImport implements ToModel,WithStartRow
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        if ($row[3] !='IC109011624') {
          
            ActivityLogger::activity("the entry ac_no is ".$row[3]."not  IC109011624 in TransactionsWUSMSImport" );
            return null;
        }
