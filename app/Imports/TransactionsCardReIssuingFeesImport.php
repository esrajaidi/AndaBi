...
class TransactionsCardReIssuingFeesImport implements ToModel,WithStartRow
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        if ($row[3] !='IC109012804') {
          
            ActivityLogger::activity("the entry ac_no is ".$row[3]."not  IC109012804 in TransactionsCardReIssuingFeesImport" );
            return null;
        }
        ...
        return new TransactionCardReIssuingFees([
            'trn_ref_no' => $row[0],
            'event' => $row[1],
            'brn' => $row[2],
            'ac_no' => $row[3],
