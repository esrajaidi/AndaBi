...
class TransactionMasterCardMangmentFeesImport implements ToModel,WithStartRow
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        if ($row[3] !='IC109011673') {
          
            ActivityLogger::activity("the entry ac_no is ".$row[3]."not  IC109011673 in Transaction MasterCard Magment FeesImport" );
            return null;
        }
        ...
        return new TransactionMasterCardMangmentFees([
            'trn_ref_no' => $row[0],
            'event' => $row[1],
            'brn' => $row[2],
            'ac_no' => $row[3],
