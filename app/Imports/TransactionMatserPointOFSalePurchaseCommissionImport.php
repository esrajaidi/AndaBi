...
class TransactionMatserPointOFSalePurchaseCommissionImport implements ToModel,WithStartRow
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        if ($row[3] !='IC109011656') {
          
            ActivityLogger::activity("the entry ac_no is ".$row[3]."not  IC109011656 in Transaction Matser Point OF Sale Purchase Commission Import" );
            return null;
        }
        ...
        return new TransactionMatserPointOFSalePurchaseCommission([
            'trn_ref_no' => $row[0],
            'event' => $row[1],
            'brn' => $row[2],
            'ac_no' => $row[3],
