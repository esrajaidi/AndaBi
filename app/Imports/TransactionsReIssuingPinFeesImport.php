...
class TransactionsReIssuingPinFeesImport implements ToModel,WithStartRow
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        if ($row[3] !='IC109012805') {
          
            ActivityLogger::activity("the entry ac_no is ".$row[3]."not  IC109012805 in TransactionsReIssuingPinFeesImport" );
            return null;
        }
        ...
        return new TransactionReIssuingPinFees([
            'trn_ref_no' => $row[0],
            'event' => $row[1],
            'brn' => $row[2],
            'ac_no' => $row[3],
