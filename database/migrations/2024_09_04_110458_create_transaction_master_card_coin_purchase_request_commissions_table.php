...
return new class extends Migration
{
    ...
    {
        Schema::create('transaction_master_card_coin_purchase_request_commissions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('transaction_master_card_coin_purchase_request_commissions');
    }
};
