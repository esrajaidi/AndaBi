...
return new class extends Migration
{
    ...
    {
        Schema::create('transaction_o_b_d_x_coms', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('entry_sr_no')->nullable(); // Entry Serial Number
            $table->timestamps(); // Created at and Updated at ti
        });
    }
    ...
    {
        Schema::dropIfExists('transaction_o_b_d_x_coms');
    }
};
