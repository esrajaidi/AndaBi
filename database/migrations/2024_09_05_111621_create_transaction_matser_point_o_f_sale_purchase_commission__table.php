...
return new class extends Migration
{
    ...
    {
        Schema::create('transaction_matser_point_o_f_sale_purchase_commission_', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('transaction_matser_point_o_f_sale_purchase_commission_');
    }
};
